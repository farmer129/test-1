...
filepath = str(base_dir) + '/data/' + 'Protokolle_BV_13_1822'
filelist = os.listdir(filepath)

for file in filelist:
    data = readDB('Protokolle_BV_13_1822', file[:-5])
    content = ''
    ...
    filepath_img = str(base_dir) + '/jkan/' + 'Protokolle_BV_13_1822/' + file[:-5]
    ...
    for img in filelist_img:
        ...
        mdFile.new_line('  url: ../../Protokolle_BV_13_1822/' + file[:-5] + '/' + img)
    mdFile.new_line('category: ')
    mdFile.new_line('  - ' + 'Protokolle_BV_13_1822')
